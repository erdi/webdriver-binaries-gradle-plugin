...
| `architecture`            | String                                  | The architecture of the binaries to be used. The allowed values are `X86`, `X86_64` and `ARM64`. Defaults to the architecture of the OS running the build.                                                                                                                                                                                                                                                                              |
...
Note that a dependency on a resolve task for a given driver binary is not added unless a version of the binary for that particular driver is specified using one of the properties
of `webdriverBinaries` extension.
